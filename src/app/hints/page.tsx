...
const hintSections: HintSection[] = [
  ...
  {
    title: 'LASTSTEP2 提出場所「？」',
    groups: [
      {
        label: 'お題',
        hints: [
          '卵の黄身を提出した時のことを思い出しましょう。パックの中の卵ごと提出しています',
          '蜘蛛が複数ある球体の中に一つだけあることが分かっているため、蜘蛛の外を指定することで蜘蛛の外側ごと提出できないでしょうか？',
          'お,F,蜘蛛,外で提出しましょう'
        ],
      },
    ],
  ...
  {
    title: 'LASTSTEP3 提出場所「お」',
    groups: [
      {
        label: 'お題',
        hints: [
          '写真をよく観察してみましょう。拡大もしてみると良いかもしれません',
          '影に注目すると良いかもしれません',
          '浴衣はハンガーで掛けられて影が出来ていますが、同じように影が出来ている箇所はないでしょうか？',
          '写真Dをよく見てみましょう影がないでしょうか？',
          'ラケットが斜めになっており、影ができています。ラケットの下に何かあるのではないでしょうか？',
          'ラケットの下に入りそうなサイズ、そしてラケットとセットで使う球体はないでしょうか？',
